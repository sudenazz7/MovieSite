...
public class SciFiAndFantasy {
    static Scanner scanner = new Scanner(System.in);

    public static void displaySciFiAndFantasyMovies() {
        displayFromTable("scifi_fantasy_movies", "Sci-Fi and Fantasy Movies");
    }

    public static void displaySciFiAndFantasySeries() {
        displayFromTable("scifi_fantasy_series", "Sci-Fi and Fantasy Series");
    }
