...
public class HorrorAndThriller {
    static Scanner scanner = new Scanner(System.in);

    public static void displayHorrorAndThrillerMovies() {
        displayFromTable("horror_thriller_movies", "Horror and Thriller Movies");
    }

    public static void displayHorrorAndThrillerSeries() {
        displayFromTable("horror_thriller_series", "Horror and Thriller Series");
    }
